package com.callin.interceptor;
...
@Component
public class CallinInterceptor implements HandlerInterceptor {
	
	
	
	private static final Logger log = LoggerFactory.getLogger(CallinInterceptor.class);
